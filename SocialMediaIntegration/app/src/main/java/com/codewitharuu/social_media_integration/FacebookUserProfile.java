package com.codewitharuu.social_media_integration;
...
public class FacebookUserProfile  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(FacebookUserProfile.this);
                builder_exitbutton.setTitle("Logout?")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(FacebookUserProfile.this, "Facebook Logged out successfully!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(FacebookUserProfile.this, MainActivity.class);
